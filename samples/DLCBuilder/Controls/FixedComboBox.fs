...
type FixedComboBox() =
    ...
    static member onSelectedItemChanged<'t when 't :> FixedComboBox> fn =
        ...
        AttrBuilder<'t>.CreateProperty<obj -> unit>
            ("OnSelectedItemChanged", fn, ValueSome getter, ValueSome setter, ValueSome comparer)
    ...
    static member selectedItem<'t when 't :> FixedComboBox>(value: obj) =
        ...
        AttrBuilder<'t>.CreateProperty<obj>
    ...
    static member dataItems<'t when 't :> FixedComboBox>(items: IEnumerable) =
        ...
        AttrBuilder<'t>.CreateProperty<IEnumerable>
            ("DataItems", items, ValueSome getter, ValueSome setter, ValueNone)
